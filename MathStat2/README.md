...
* * **Union data**: [https://raw.githubusercontent.com/mirkosignorelli/Teaching/refs/heads/main/OidS/union.txt]. Notice that fitting a GLMM on the whole dataset could be time-consuming, so you may want to work on a subset of the subject identifiers.
